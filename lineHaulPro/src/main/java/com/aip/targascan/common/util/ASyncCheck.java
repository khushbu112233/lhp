...
public class ASyncCheck extends AsyncTask<String, Integer, Integer> {
    ...
    public ASyncCheck(Context activity,ICallback callback) {        
        this.mContext = activity;        
        mCallback = callback;
    }

    @Override
    public Integer doInBackground(String... notused) {
...
//                            Log.e("mVersionDownloadable", "" + mVersionDownloadable);
    ...
    public void onPostExecute(Integer result) {
        mCallback.run(mVersionDownloadable);
    }
